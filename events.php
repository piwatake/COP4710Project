          ...
          <h2>Latest Events</h2> 
            ...
            { ?> 
                ...
                <?php 
                    ...
                    while ($count < $sqlNum) 
                    { 
                        $eventid = db_result($sqlResult, $count, "EventID"); 
                        $cat = db_result($sqlResult, $count, "EventCat"); 
                        $name = db_result($sqlResult, $count, "EventName"); 
                        $desc = db_result($sqlResult, $count, "description"); 
                        $phone = db_result($sqlResult, $count, "ContactPhone"); 
                        $email = db_result($sqlResult, $count, "ContactEmail"); 
                        $adminid = db_result($sqlResult, $count, "Admin_AdminID"); 
                        $loc = db_result($sqlResult, $count, "Location_Name"); 
                        //$bldg = db_result($sqlResult, $count, "Building"); 
                        $datetime = db_result($sqlResult, $count, "DateTime"); 
                        $vis = db_result($sqlResult, $count, "Visibility"); 
                        //$rating = db_result($sqlResult, $count, "Rating"); 
                        $link = db_result($sqlResult, $count, "Link"); 
                ...
                ?> 
                    ...
                    <p> 
                        ...
                        $rating = db_result($sqlAvgResult, 0, "Rating"); 
                        ...
                        { 
                            $acomm = db_result($sqlcommsres, $count4, "commentcontent"); 
